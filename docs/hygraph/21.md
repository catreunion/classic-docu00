...
The router combines all the returned responses into a single JSON object.
...
**Reference resolvers** are used to directly access the entity fields that each subgraph contributes.
